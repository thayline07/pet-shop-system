...
import { DeleteIcon, Loader2, Pen, Trash2 } from 'lucide-react';
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
import { deleteAppointment } from '@/src/app/actions';
...
export const AppointmentCard = ({
  ...
  return (
    <div
      className={cn(
        'grid grid-cols-2 md:grid-cols-[15%_35%_30%_20%] py-3 items-center',
